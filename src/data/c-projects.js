export const C_PROJECTS = [
  {
    ...
    what:
      "A simulation where N philosophers sit at a round table, each needing two shared forks to eat. Every philosopher runs on its own pthread, cycling through thinking, being hungry, eating, and sleeping — forever, without ever crashing, deadlocking, or letting a philosopher starve.",
    how: [
